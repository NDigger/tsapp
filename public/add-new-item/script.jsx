...
const App = () => {
    ...
    const onSubmit = e => {
        ...
        img.onload = () => {
            ...
            if (w < minResolution.w || h < minResolution.h) return setErrorText(`Min resolution is ${minResolution.w}x${minResolution.h}`)
            else if (w / h > 2) return setErrorText(`Width can't be more than 2× height. Current resolution: ${w}x${h}`)
            else if (h / w > 2) return setErrorText(`Height can't be more than 2× width. Current resolution: ${w}x${h}`)
